...
<div class="row">
    <div class="row">
	 ...
	 <h2 style = "text-align: center; font-weight= bold; text-decoration:underline; font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;">About <?php echo $_GET['user']; ?>:</h2>
